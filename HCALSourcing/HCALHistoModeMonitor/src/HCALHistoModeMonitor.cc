// -*- C++ -*-
//
// Package:    HCALHistoModeMonitor
// Class:      HCALHistoModeMonitor
// 
/**\class HCALHistoModeMonitor HCALHistoModeMonitor.cc HCALSourcing/HCALHistoModeMonitor/src/HCALHistoModeMonitor.cc
...
// class declaration
//
class HCALHistoModeMonitor : public edm::EDAnalyzer {
   public:
      explicit HCALHistoModeMonitor(const edm::ParameterSet&);
      ~HCALHistoModeMonitor();
...
//
HCALHistoModeMonitor::HCALHistoModeMonitor(const edm::ParameterSet& iConfig) :
...
HCALHistoModeMonitor::~HCALHistoModeMonitor()
{
...
//
//
bool HCALHistoModeMonitor::isDigiAssociatedToSourceTube(const HcalDetId& detId, std::string tubeName)
{
  using namespace std;
  int ieta = detId.ieta();
  int iphi = detId.iphi();
...
void
HCALHistoModeMonitor::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  using namespace std;
...
//   iEvent.getByToken(digiCollTok, pIn);
  ...
  //  const HcalUHTRhistogramDigiCollection& hcalHistDigiColl=*(*itr);
	...
	//cout<<"====Digi Size "<<idigi->size()<<endl;
...
// 	if (detId.ieta()==30 || detId.ieta()==34)
// 	{
// 	cout<<"===================================================="<<endl;
// 	cout<<"===================================================="<<endl;
// 	cout<<"DIGI size "<<idigi->size()<<endl;
// 	cout<<"Tube Name "<<tubeName<<endl;
// 	cout << "iEta: "<< detId.ieta() << " iPhi: " << detId.iphi() << " Depth: " << detId.depth() << endl; 
// 	cout<<"===================================================="<<endl;
// 	cout<<"===================================================="<<endl;
// 
// 	}
...
void 
HCALHistoModeMonitor::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
HCALHistoModeMonitor::endJob() 
{
  rootFile_->cd();
  eventTree_->Write();
  histEntries_->Write();
...
void 
HCALHistoModeMonitor::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
HCALHistoModeMonitor::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
HCALHistoModeMonitor::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
HCALHistoModeMonitor::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
HCALHistoModeMonitor::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(HCALHistoModeMonitor);
