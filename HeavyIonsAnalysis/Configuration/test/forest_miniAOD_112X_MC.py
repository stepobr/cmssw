...
#customisation
# This adds both re-clustering jets, pat jet sequences and forest analyzers
# Not working at the moment

# algolist = ['akPu4PF','akPu5PF']
# from HeavyIonsAnalysis.JetAnalysis.heavyIonJetSetup import setupHeavyIonJetsWithBTagging
# for algo in algolist:
#     setupHeavyIonJetsWithBTagging(algo, process.jetSequence, process, "false")